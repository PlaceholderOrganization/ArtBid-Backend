...
class AuctionServiceTest {
    ...
    void testFindByIdFound(){
        AuctionResponse response = auctionService.findById(a1.getAuctionId());
        assertEquals(a1.getAuctionId(), response.getAuctionId());
        assertEquals(5000, response.getStartBid());
    }
    ...
    void testAddAuction(){
        ...
        assertEquals(5, response.getArtworkId());
        assertTrue(auctionRepository.existsById(response.getAuctionId()));
    }

    @Test
    void testAddAuctionAlreadyExistingThrows(){
        AuctionRequest request = new AuctionRequest();
        request.setAuctionId(a1.getAuctionId());
    ...
    void testEditAuctionCorrectInput(){
        ...
        auctionService.editAuction(request, a1.getAuctionId());
